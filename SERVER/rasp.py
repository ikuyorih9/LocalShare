...
def main():
    ...
    while True:
        print("\nOpções disponíveis:")
        print("1. cadastro - Criar uma conta no LiveServer")
        print("2. login - Iniciar sesão")
        print("3. sair - Desconectar do LiveServer")
        ...
        if operacao == "cadastro":
            ...
            username = input("Digite o nome de usuário para login: ")
            password = input("Digite a senha: ")
            caminho_usuario = verificar_login(username, password)
            if caminho_usuario:
                print("Login bem-sucedido!")
                manipular_diretorio_usuario(caminho_usuario)
            else:
                print("Nome de usuário ou senha incorretos.")

        elif operacao == "sair":
            print("Obrigado por utilizar o LiveServer = )")
            break
